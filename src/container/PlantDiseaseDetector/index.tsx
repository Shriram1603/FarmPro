...
const PlantDiseaseDetector = () => {
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <Text style={{ marginVertical: moderateVerticalScale(20), marginHorizontal: moderateScale(20), fontFamily: 'Sen-ExtraBold', fontSize: scale(19), color: 'black' }}>Let's get started</Text>
